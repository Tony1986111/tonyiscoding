...
const BusinessCard = () => {
  ...
  const propertyStyle = {
    color: '#f88070' // salmon pink for properties
  };
  
  const valueStyle = {
    color: '#dcdcaa' // yellowish for values
  };
    ...
    <div className="flex items-center justify-center p-4">
      <div style={editorStyle}>
        <div style={headerStyle}>
          ...
          <h1 style={titleStyle}>Business Card.json</h1>
        ...
        <div style={{
          ...
          <div style={{display: 'flex', alignItems: 'center', margin: '0 8px', color: '#d4d4d4'}}>
            {/* 文档图标 */}
          ...
          {/* 右侧方框图标 */}
          <svg width="24" height="24" viewBox="0 0 24 24" style={{marginRight: '8px', color: '#d4d4d4'}}>
            <path fill="currentColor" d="M19,3H5C3.89,3 3,3.9 3,5V19A2,2 0 0,0 5,21H19A2,2 0 0,0 21,19V5C21,3.89 20.1,3 19,3Z" />
          </svg>
          
          {/* 三点图标 */}
          <div style={{color: '#d4d4d4', fontWeight: 'bold', fontSize: '18px'}}>...</div>
        </div>
        ...
        <div className="font-mono text-sm">
          ...
          <div className="mb-1 flex">
            ...
            <div className="ml-4">
              ...
              <span>: </span>
              <span style={valueStyle}>"您的名字"</span>,
            </div>
          </div>
          <div className="mb-1 flex">
            ...
            <div className="ml-4">
              ...
              <span>: </span>
              <span style={valueStyle}>"您的职位"</span>,
            </div>
          </div>
          <div className="mb-1 flex">
            ...
            <div className="ml-4">
              ...
              <span>: </span>
              <span style={valueStyle}>"your@email.com"</span>,
            </div>
          </div>
          <div className="mb-1 flex">
            ...
            <div className="ml-4">
              ...
              <span>: </span>
              <span style={valueStyle}>"yourwebsite.com"</span>
            </div>
          </div>
          <div className="mb-1 flex">
